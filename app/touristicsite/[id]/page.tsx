...
import { ArtisanGridSkeleton } from "../components/skeletons/ArtisanGridSkeleton";
import { TouristSiteCardSkeleton } from "../components/skeletons/TouristSiteCardSkeleton";
      ...
      <TouristSiteCard {...transformedSite} />
       ...
       <div className="max-w-3xl mx-auto mb-5">
         <h3 className="text-base md:text-lg font-semibold mb-4 flex items-center gap-2 text-[#78350F]">
           <Image src="/icons/store.svg" alt="Artisanat" width={20} height={20} />
