...
interface DetailsShopProps {
  params: {
    id: Id<"artisanShops">;
  };
}
const DetailsShop = ({ params }: DetailsShopProps) => {
  const { id } = params;
        ...
        <div>
          <div className='bg-gray-50'>
            ...
            <div className='w-full h-[600px] relative'>
              <Image
                src={shop.images[0] || "/images/artisanal-shop-img/weaver-shop.svg"}
                alt={shop.name}
                fill
                  ...
                  <div className="py-8 md:px-12 px-6 max-w-6xl mx-auto text-white flex flex-col items-start justify-between">
                    ...
                    <div className='flex items-center justify-between w-full gap-8 flex-wrap'>
                      <div className='flex items-start flex-col gap-2'>
                        <h1 className="text-3xl font-semibold text-white">{shop.name}</h1>
                        ...
                        {(() => {
                          ...
                          const todaySchedule = shop.openingHours?.find(day => day.day === today);
                          if (!todaySchedule) {
                            return (
                            ...
                            <div className="flex flex-col gap-1">
                              <div className="flex items-center justify-between text-sm">
                                {todaySchedule.isClosed ? (
                                  <span className="bg-red-500 text-white font-medium px-2 py-1 rounded-full">Fermé</span>
                                ) : (
                                  <span className="bg-green-500 text-white font-medium px-2 py-1 rounded-full">
                                    Ouvert {todaySchedule.openingTime} - {todaySchedule.closingTime}
                                  </span>
                                )}
                              </div>
                            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 py-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-8">
                ...
                <section className="bg-white rounded-lg p-6">
                  <h1 className="text-2xl text-gray-900 mb-4">À propos de l'atelier</h1>
                      ...
                      <div key={product.id} className='flex flex-col'>
                        ...
                        <div className='flex flex-col gap-2'>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-lg text-yellow-500">{formatPrice(product.price)}</span>
            ...
            <section className="mt-12 bg-white rounded-lg p-6">
              <h2 className="text-xl text-gray-900 text-center mb-8">Autres Boutiques</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {!otherShop ? (
                  ...
                  otherShop.map((shop) => (
                    <div key={shop._id} className="embla__slide flex-[0_0_375px]">
